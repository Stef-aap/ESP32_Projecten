...
def _( ID, text ):
  ...
  # Get the file from which this procedure was callec
  Frame = 1
  ...
  if FileName in _LT_missing :
    print('_______MISSING',ID,SourceFile)
    return text

  # if selected language is identical to module language
  """
  Language_This_Module = None
  try :
    exec ( 'from ' + FileName + ' import Language_This_Module' )
  except :
  ...
  ## print '_______',ID,SourceFile,FileName,text, '$$'
  ...
  if not ( FileName in _LT ) :
    ...
    try :
      exec ( 'from ' + FileName + '_' + LC + ' import LT')
      try :
        _LT [ FileName ] = LT
        #print 'FOUND'
      except :
...
if __name__ == '__main__':
  ...
  print(_(1,'hello'))
  print(_(2,'bye'))
  print(_(3,'good morning'))
  print(_(0,'good evening'))
